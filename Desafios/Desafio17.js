(function() {
  ...
  */
  ...
  let myName = 'Junior Lima';
  let newText1 = text.replace(/Manuel Marques de Sousa/, myName);
  ...
  */
  ...
  let city = 'São Paulo';
  let newText2 = newText1.replace(/brasileiro/, city);
  ...
  */
  ...
  let newText3 = newText2.replace(/\d/g, '-');
  ...
  */
  ...
  let newText4 = newText3.replace(/[D-Hd-h]/g, '0');
  ...
  */
  ...
  let newText5 = newText4.replace(/A/gi, '4');
  ...
  */
  ...
  let newText6 = newText5.replace(/O Centauro de Luvas/g, match => match.toUpperCase());
  ...
  */
  ...
  let regexDate = /(\d{1,2}) de (janeiro|fevereiro|março|abril|maio|junho|julho|agosto|setembro|outubro|novembro|dezembro) de (\d{4})/gi;
  // ?
  ...
  console o resultado.
  */
  function replaceDate(p1, p2, p3) {
    let monthNumber = getMonthNumber(p2);
    return `${p1}/${monthNumber}/${p3}`;
  }

  console.log('\nReplace de datas:');
  let newText7 = newText6.replace(regexDate, replaceDate);
