(function() {
  ...
  */
  ...
  let justNumbersAndLetters = createRegex(pattern, flags);

  let testString = "abc123DEF!";
  console.log(testString.match(justNumbersAndLetters)); 
  ...
  */
  ...
  var matches = text.match(justNumbersRegex);
  ...
  */
  ...
  var matches = otherText.match(numbersAtTheEnd);
  ...
  */
  ...
  function hasClass(markup, cssClass) {
    ...
    var elementsWithClass = tempElement.getElementsByClassName(cssClass);

    return elementsWithClass.length > 0;
  }

  var markup = '<main>\n  <div class="container">\n    <span class="text date"></span>\n    <p class=\'excerpt\'></p>\n  </div>\n</main>';
  var classesToTest = ["container", "text date", "excerpt", "main"];

  classesToTest.forEach(function(cssClass) {
    var result = hasClass(markup, cssClass);
    console.log((result ? "true" : "false") + " para a classe " + cssClass);
  });
  // ?
})()