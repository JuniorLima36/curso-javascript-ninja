(function() {
  ...
  */
  ...
  cpfs.forEach(function(cpf) {
    ...
    console.log(formatCPF(cleanedCPF));
  });
  // ?
  ...
  */
  ...
  var regexJuneJuly = /\bju(?:lho|nho)\b/g;
  var sentence = "Os meses de janeiro, junho e julho começam com a letra j.";
  console.log(sentence.match(regexJuneJuly));
  // ?
  ...
  */
  ...
  var regexOpenTag = /<\w+>/g;
  var htmlString = "<div><section><blockquote>Texto <img /></blockquote></section></div>";
  console.log(htmlString.match(regexOpenTag));
  // ?
  ...
  */
  ...
  var regexEmptyTags = /<(\w+)><\/\1>/g;
  var htmlStringEmpty = "<div><ul><li></li><li></li><li><span></span></li></ul></div>";
  console.log(htmlStringEmpty.match(regexEmptyTags));
  // ?
  ...
  */
  ...
  var regexTextInsideTags = /<(\w+)>([^<]+)<\/\1>/g;
  var htmlTextString = "<h1>Título da página</h1><p>Este é um parágrafo</p><footer>Rodapé</footer>";
  
  var formattedHtml = htmlTextString.replace(regexTextInsideTags, function(match, tag, text) {
